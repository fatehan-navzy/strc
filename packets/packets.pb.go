...
type Compact struct {
	...
	Temperature                                 *float32 `protobuf:"fixed32,652,opt,name=temperature,proto3,oneof" json:"temperature,omitempty"`
	unknownFields                               protoimpl.UnknownFields
	sizeCache                                   protoimpl.SizeCache
}
...
func (x *Compact) GetOperatorCode() uint32 {
...
func (x *Compact) GetTemperature() float32 {
...
const file_packets_packets_proto_rawDesc = "" +
	...
	"\vtemperature\x18\x8c\x05 \x01(\x02H\xc3\x04R\vtemperature\x88\x01\x01\x1a;\n" +
